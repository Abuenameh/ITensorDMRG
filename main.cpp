...
void groundstate(queue<Results>& resq, Sweeps& sweeps, Real errgoal, bool quiet, BoseHubbardSiteSet& sites, vector<vector<IQMPO> >& COp, int it, int iN, vector<Real> ts, vector<Real> Us, vector<Real> mus, int N)
{
...
int main2(int argc, char **argv)
{
    ...
    time_point<system_clock> end = system_clock::now();
    std::chrono::seconds runtime = end - start;
